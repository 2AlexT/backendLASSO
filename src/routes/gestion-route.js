...
const router=express.Router({mergeParams:true});
    ...
    router.post('/empresa/:id_empresa/gestion/modificarGestion',ldapController.protect,gestionController.modificarGestion)
    router.post('/empresa/:id_empresa/gestion/crearGestion',ldapController.protect,gestionController.createNewGestion)
    router.post('/empresa/:id_empresa/gestion/darAltaGestion',ldapController.protect,gestionController.gestionDarAlta)
